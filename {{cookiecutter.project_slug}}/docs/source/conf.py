...
man_pages = [(master_doc, '{{cookiecutter.project_slug}}', '{{cookiecutter.project_slug}} Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, '{{cookiecutter.project_slug}}', '{{cookiecutter.project_slug}} Documentation', author, '{{cookiecutter.project_slug}}',
